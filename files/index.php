...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div >
         ...
         <h3 align="centert"><img src="logo.png" style="height:50px; justify-content:center"> 
         TIME TABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/lab22.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lab33.jpg" alt="Flower">
        </div>
    </div>
</div> 
...
<div class="container" style="color:white" >
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Fr Agnel Ashram Bandstand , Bandra(w) Mumbai 400050
                </h4>
                <h4><strong>Call:</strong> 22-67114000 </h4>
                <h4><strong>Email: </strong>crce@frcrce.ac.in</h4>
            </div>
