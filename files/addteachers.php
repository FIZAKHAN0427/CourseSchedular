...
<head>
    ...
    <style>
        h1, h2, h3, p, a, span, button, label, th, tbody, option, #teacherstable #EnterTeacher {
  color: white; /* Set the color of specific text elements to white */
}
...
<div>
    ...
    <caption style="color: white;"><strong>Teacher's Information</strong></caption>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        echo "<tr><td>{$row['faculty_number']}</td>
                ...
                <td>{$row['emailid']}</td>
               <td>
                <button style='background-color: rgba(28, 43, 75, 1); color: white; padding: 5px 10px; border: none; border-radius: 3px;'>Delete</button></td>
                </tr>\n";
    }
